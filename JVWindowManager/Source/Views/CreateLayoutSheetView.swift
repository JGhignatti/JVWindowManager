...
//                    }
//
//                    Section(header: Text("Shortcut configuration").font(.headline))
//                    {
//                        GeometryReader { g in
//                            HStack {
//                                Spacer()
...
//                                        .frame(width: 2 * g.size.width / 3, height: 48)
//                                    
//                                    Text("Click to enter shortcut")
//                                }
//                                Spacer()
//                            }
//                        }
